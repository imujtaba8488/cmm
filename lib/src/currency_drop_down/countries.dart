import '../util/country.dart';

final List<Country> sortedCountryList = List.of(countryList);

List<Country> sorted() {
  sortedCountryList.sort((c1, c2) {
...
/// Returns a list of currency codes sorted alphabetically without any duplicates.
List<String> currencyCodesSorted() {
  ...
  return currencyCodes.toSet().toList();
}
